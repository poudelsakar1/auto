...
const Modal: React.FC<IProps> = ({
  ...
  return (
    ...
    >
      <div
        id='modal-toggle'
        data-qa-modal-toggle
        className='modal-overlay absolute w-full h-full bg-gray-900 opacity-50'
        onClick={() => onToggle()}
      ></div>

      <div
        id='modal-sub-container'
        data-qa-modal-sub-container
        className='modal-container bg-white w-11/12 md:max-w-760px mx-auto custom-modal-height rounded-lg shadow-lg z-50 overflow-y-auto'
      >
        <div
        ...
        <div
          ...
          data-qa-modal-close-button2
          className='modal-content py-10 text-left px-12 relative'
        >
          <div
            id="modal-close-button-container"
            data-qa-modal-close-button-container
            onClick={() => onToggle()}
          ...
          <div id="modal-submit-button" data-qa-modal-submit-button className='flex justify-end'>
            <button
